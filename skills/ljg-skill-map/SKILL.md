...
### 3. 渲染
常规文档格式，案例如下：
SKILL MAP · 100 skills installed
  =================================

  ◆ 认知原子 (14)
  ──────────────────────────────────────────────────
    ljg-learn        —    /  概念解剖——8维度深钻到顿悟
    ljg-think        —    /  追本之箭——一路钻到不可再分的本质
    ljg-qa           —    /  信息提问机——把核心观点抽成 Q-A 对
  

  ▲ 输出铸造 (10)
  ──────────────────────────────────────────────────
    ljg-paper-river v1.0  /  论文倒读——递归追溯问题演化史
